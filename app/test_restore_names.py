...
def test_restore_names_does_not_overwrite_existing_first_name():
    users = [{"first_name": "Jack", "last_name": "Holy", "full_name": "Jack Holy"}]
    restore_names(users)
    assert users == [
        {"first_name": "Jack", "last_name": "Holy", "full_name": "Jack Holy"}
    ]
...
def test_restore_names_with_multiple_mixed_users():
    users = [
